...
pred_prob = np.load(f'{OUT_DIR}/pred_prob_ensemble.npy')  # TTA-averaged probability map
...
Image.fromarray(overlay_roads).save(f'{OUT_DIR}/best_extraction_overlay.png')
...
with open(f'{OUT_DIR}/all_features_best.geojson', 'w') as f:
    json.dump({'type': 'FeatureCollection', 'features': features}, f, indent=2)

with open(f'{OUT_DIR}/buildings_best.json', 'w') as f:
    json.dump(building_records, f, indent=2)
with open(f'{OUT_DIR}/roads_best.json', 'w') as f:
    json.dump(road_records, f, indent=2)
with open(f'{OUT_DIR}/water_best.json', 'w') as f:
    json.dump(water_records, f, indent=2)

print('\nAll features exported to all_features_best.geojson')
