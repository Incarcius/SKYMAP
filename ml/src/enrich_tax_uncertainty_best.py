...
with open(f'{OUT_DIR}/buildings_regularized.json') as f:
    buildings = json.load(f)

pred_prob = np.load(f'{OUT_DIR}/pred_prob_ensemble.npy')
H, W = pred_prob.shape
...
with open(f'{OUT_DIR}/buildings_best_enriched.json', 'w') as f:
